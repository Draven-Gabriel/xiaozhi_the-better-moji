export default {
  ...
  'register.welcome': 'Welcome aboard',
  ...
  'home.greeting': 'Hello, welcome back',
  ...
  'home.statAgents': 'Total Agents',
  'home.statDevices': 'Total Devices',
  'home.statOnline': 'Online Devices',
  'home.photoCaption': 'Make every day worth looking forward to',
  'home.llmDistribution': 'Model Distribution',
  'home.emptyTitle': 'No agents yet',
  'home.emptyDesc': 'Create your first agent to start configuring roles and devices',
  ...
  'roleConfig.tooltip.contextProvider': 'When the agent is awakened, fetch external system data and dynamically inject it into the LLM system prompt',
