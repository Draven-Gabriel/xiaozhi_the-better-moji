                    ...
                    <el-card class="params-card" shadow="never">
                        ...
                        <CustomTable ref="paramsTable" :data="paramsList" :columns="tableColumns" :loading="loading"
                            ...
                            <template slot="operations" slot-scope="scope">
                                <UiButton type="text" size="small" class="row-action-btn"
                                    @click="downloadFirmware(scope.row)">{{ $t('otaManagement.download') }}</UiButton>
                                <UiButton type="text" size="small" class="row-action-btn"
                                    @click="editParam(scope.row)">
                                    {{ $t('otaManagement.edit') }}
                                </UiButton>
                                <UiButton type="text" size="small" class="row-action-btn delete-btn"
...
export default {
    components: { HeaderBar, FirmwareDialog, VersionFooter, CustomButton, CustomTable, UiButton },
    data() {
        return {
            searchName: "",
            loading: false,
