...
.doc-grid {
  ...
  gap: var(--apple-space-4) var(--apple-space-5);
  flex: 1;
  min-height: 0;
  overflow-y: auto;
...
.progress-ring {
  ...
  .fg {
    ...
    &.complete { stroke: var(--apple-success); }
    &.processing { stroke: var(--apple-brand); }
    &.pending { stroke: var(--apple-divider); }
  }
}
...
.progress-container {
  ...
  .progress-label {
    ...
    &.complete { color: var(--apple-success); }
    &.processing { color: var(--apple-brand); }
  }
