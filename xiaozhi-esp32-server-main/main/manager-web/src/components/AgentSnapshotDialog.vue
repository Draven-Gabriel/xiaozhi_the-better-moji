...
.snapshot-footer-cancel {
  ...
  &:focus {
    ...
    background: var(--apple-brand-tint);
    color: var(--apple-brand);
    box-shadow: 0 2px 8px rgba(0, 113, 227, 0.14);
...
::v-deep .snapshot-table {
  background-color: var(--apple-surface);
  border-radius: var(--apple-radius-md);
}

::v-deep .snapshot-table th.el-table__cell {
...
::v-deep .snapshot-table td.el-table__cell {
  border-bottom: 1px solid var(--apple-divider-soft) !important;
}
