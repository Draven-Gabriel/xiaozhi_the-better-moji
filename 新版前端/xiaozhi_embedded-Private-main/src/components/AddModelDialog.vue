...
.add-model-dialog {
  ...
  ::v-deep .el-dialog__footer {
    ...
    .custom-button--confirm {
      background: var(--apple-brand) !important;
    ...
    .custom-button--confirm:focus {
      background: var(--apple-brand-hover) !important;
      box-shadow: 0 4px 12px rgba(0, 113, 227, 0.28) !important;
      transform: translateY(-1px);
    }
    .custom-button--confirm:active {
      background: var(--apple-brand-active) !important;
...
.custom-input-bg .el-input__inner:focus {
  border-color: var(--apple-brand);
  background-color: var(--apple-surface);
  box-shadow: 0 0 0 4px rgba(0, 113, 227, 0.24);
}
.custom-input-bg .el-input__inner::placeholder {
