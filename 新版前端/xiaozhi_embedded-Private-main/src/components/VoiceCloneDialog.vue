...
.audio-uploader {
    ...
    ::v-deep .el-upload-dragger {
        ...
        border: 1.5px dashed var(--apple-divider);
...
.edit-tips {
    ...
    border-left: 3px solid var(--apple-brand);
...
.audio-controls ::v-deep .el-button--primary {
...
.audio-controls ::v-deep .el-button:not(.el-button--primary) {
