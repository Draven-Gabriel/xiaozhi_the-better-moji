...
.app-page-enter-active { transition: opacity 0.3s cubic-bezier(0.4, 0, 0.2, 1), transform 0.3s cubic-bezier(0.4, 0, 0.2, 1); }
.app-page-leave-active { transition: opacity 0.15s cubic-bezier(0.4, 0, 0.2, 1); }
.app-page-enter { opacity: 0; transform: translateY(10px); }
.app-page-leave-to { opacity: 0; }
</style>
<script>
