                    ...
                    <el-card class="params-card" shadow="never">
                        ...
                        <CustomTable ref="voiceTable" :data="voiceCloneList" :columns="tableColumns" :loading="loading"
                            ...
                            <template slot="trainStatus" slot-scope="scope">
                                <UiTag :type="getTrainStatusTagType(scope.row)" size="small">{{ getTrainStatusText(scope.row) }}</UiTag>
                            </template>
                            <template slot="createdAt" slot-scope="scope">
                                {{ formatDate(scope.row.createDate) }}
                            </template>
                            <template slot="operations" slot-scope="scope">
                                <UiButton type="text" size="small" class="delete-btn"
                                    @click="deleteVoiceClone(scope.row)">{{ $t('voiceClone.delete') }}</UiButton>
                            </template>
...
export default {
    components: { HeaderBar, VoiceCloneDialog, VersionFooter, CustomButton, CustomTable, UiButton, UiTag },
    data() {
        return {
            searchName: "",
            loading: false,
