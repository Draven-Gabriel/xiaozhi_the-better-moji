...
#define MAIN_EVENT_BARGEIN_CHECK        (1 << 14)
#endif
...
private:
    ...
    int last_vad_speech_tick_ = 0;
    int last_vad_state_tick_ = 0;
    TaskHandle_t activation_task_handle_ = nullptr;

#ifdef CONFIG_USE_DEVICE_AEC
    esp_timer_handle_t bargein_timer_ = nullptr;
    bool bargein_capture_ = false;
    bool bargein_triggered_ = false;
    int64_t bargein_vad_start_ms_ = 0;
    std::deque<std::unique_ptr<AudioStreamPacket>> bargein_audio_cache_;

    void CheckBargeIn();
    void BargeIn(AbortReason reason);
    void FlushBargeInAudioCache();
#endif
